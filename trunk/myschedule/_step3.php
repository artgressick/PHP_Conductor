<?
		...
		if ($errcnt == 0) {
			...
			<p>Congratulations you've registered for staffing at ".$_SESSION['chrEvent'].". Stay tuned for the booth times you're selected to staff.</p>
		...
		while ($row = mysqli_fetch_assoc($results)) {
			...
			<p>Keep in mind that you will only be selected to work at most two shifts per day.</p>
			...
			<p>You may consider waiting to book travel until you know your staffing schedule.</p>
			
			<p>Send questions to <a href='mailto:".$PROJECT_EMAIL."'>".$PROJECT_EMAIL."</a>.</p>
			
			<p>Thanks. See you at the Event!<br />
			".$PROJECT_NAME."</p>";
